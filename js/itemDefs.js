...
const BASE_INVENTORY_ITEMS={
    ...
    masterContract:{name:"CONTRAT DU MAÎTRE",short:"CONTRAT DU MAÎTRE",emoji:"📜",action:"UTILISER",desc:"Au lancement du prochain donjon, permet au joueur de choisir une contrainte supplémentaire. Si le donjon est terminé, les récompenses augmentent de 20 %. Contraintes : Surcharge — objectifs multipliés par 1,5 ; Chemin scellé — les salles doivent être accomplies dans l’ordre ; Sans échappatoire — aucun objet permettant d’éviter ou de faciliter une salle ne peut être utilisé pendant le donjon.",obtain:["Après avoir complété toutes les quêtes journalières (Taux : 1 %).","Après avoir complété toutes les quêtes bonus (Taux : 1 %).","Après avoir complété une quête urgente (Taux : 1 %).","Après avoir accompli un nouveau record (Taux : 1 %).","Après avoir complété un donjon (Taux : 10 %).","Après avoir complété le Donjon du Guerrier (Taux : 10 %)."]},
