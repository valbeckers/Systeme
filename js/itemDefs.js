...
const BASE_INVENTORY_ITEMS={
    ...
    mysteryMap:{name:"CARTE DES PROFONDEURS",short:"CARTE DES PROFONDEURS",emoji:"🗺️",action:"DÉPLIER",desc:"Permet de choisir la statistique du prochain donjon. Le donjon précis reste aléatoire lorsqu’une statistique correspond à plusieurs donjons.",obtain:["Après avoir complété toutes les quêtes journalières (Taux : 1 %).","Après avoir complété toutes les quêtes bonus (Taux : 1 %).","Après avoir complété une quête urgente (Taux : 1 %).","Après avoir accompli un nouveau record (Taux : 1 %).","Après avoir complété un donjon (Taux : 10 %).","Après avoir complété le Donjon du Pèlerin (Taux : 10 %)."]},
    ...
    masterContract:{name:"CONTRAT DU MAÎTRE",short:"CONTRAT DU MAÎTRE",emoji:"📜",action:"UTILISER",desc:"Au lancement du prochain donjon, choisissez une contrainte supplémentaire. Si le donjon est terminé en respectant cette contrainte, la récompense finale augmente de 20 %. Contraintes : Surcharge (objectifs ×1,5), Chemin scellé (salles obligatoirement dans l’ordre) ou Sans échappatoire (aucun objet permettant d’éviter ou de faciliter une salle).",obtain:["Après avoir complété toutes les quêtes journalières (Taux : 1 %).","Après avoir complété toutes les quêtes bonus (Taux : 1 %).","Après avoir complété une quête urgente (Taux : 1 %).","Après avoir accompli un nouveau record (Taux : 1 %).","Après avoir complété un donjon (Taux : 10 %).","Après avoir complété le Donjon du Guerrier (Taux : 10 %)."]},
