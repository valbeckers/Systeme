...
// Boss alternatifs utilisés uniquement via le Contrat du Maître.
const DUNGEON_RUPTURE_BOSSES = {
  alchemist:[
    {id:"alchemist_putride",name:"Circé",objective:"2 repas équilibrés consécutifs, sans sucre transformé, junk-food ni écran"},
    {id:"alchemist_noir",name:"Le Chupacabra",objective:"Journée de purification : 2 L d’eau répartis avant 18 h et 2 repas propres"},
    {id:"alchemist_dechu",name:"Ungoliant",objective:"30 min de lumière naturelle"},
    {id:"alchemist_corrompu",name:"Le Spectre",objective:"30 min de marche en extérieur"},
  ],
  warrior:[
    {id:"warrior_berserker",name:"L’Ogre",objective:"200 pompes réparties dans la journée"},
    {id:"warrior_colosse",name:"Le Géant de Pierre",objective:"100 squats + 100 fentes"},
    {id:"warrior_gladiateur",name:"L’Évanescent",objective:"30 min de shadow boxing"},
    {id:"warrior_titan",name:"Le Troll des Montagnes",objective:"15 min de Wall Sit cumulées"},
  ],
  pilgrim:[
    {id:"pilgrim_nomade",name:"Le Draugr",objective:"30 min de marche cumulées"},
    {id:"pilgrim_voyageur_perdu",name:"Le Minotaure",objective:"Atteindre 10 000 pas"},
    {id:"pilgrim_predateur",name:"Les Wargs",objective:"20 min de corde à sauter"},
    {id:"pilgrim_messager",name:"La Horde",objective:"Courir 7 km"},
  ],
  hunter:[
    {id:"hunter_rodeur",name:"Le Basilic",objective:"10 min de déplacements latéraux rapides"},
    {id:"hunter_fauve",name:"Le Golem de Lave",objective:"20 min de footwork"},
    {id:"hunter_traqueur",name:"La Tour Noire",objective:"30 allers-retours d’escaliers"},
    {id:"hunter_acrobate",name:"Le Changeforme",objective:"30 min d’Animal Flow ou de mobilité active continue"},
  ],
  monk:[
    {id:"monk_sage_dechu",name:"Le Détraqueur",objective:"30 min de lecture profonde sans interruption"},
    {id:"monk_veilleur",name:"Māra",objective:"30 min de méditation guidée"},
    {id:"monk_ombre_interieure",name:"L’Homme Pâle",objective:"45 min de silence total, sans téléphone, musique, vidéo, podcast ni conversation"},
    {id:"monk_scribe",name:"La Fausse Hydre",objective:"Rédiger un résumé de 300 mots d’une lecture ou d’un podcast, sans consulter la source pendant la rédaction"},
  ],
  guardian:[
    {id:"guardian_commandant",name:"Le Joueur Masqué",objective:"Terminer entièrement 3 tâches repoussées"},
    {id:"guardian_sentinelle",name:"Le Mimique",objective:"Ranger entièrement une pièce"},
    {id:"guardian_stratege",name:"Le Labyrinthe",objective:"Planifier précisément la journée suivante puis commencer immédiatement la première tâche"},
    {id:"guardian_dechu",name:"Le Détraqueur",objective:"60 min de Deep Work sans interruption volontaire"},
  ],
  steward:[
    {id:"steward_negligent",name:"Le Mimique",objective:"Ranger 20 objets"},
    {id:"steward_poussiere",name:"Le Cendré",objective:"Faire la poussière pendant 30 min"},
    {id:"steward_encombreur",name:"Le Léviathan",objective:"Ranger entièrement une pièce"},
    {id:"steward_crasse",name:"Le Grand Gobelin",objective:"60 min de nettoyage domestique continu"},
  ],
};
