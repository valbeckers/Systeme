...
export const UI_ICON_IMAGES=Object.freeze({
  ...
  "quest.pushups":"./assets/ui/quest-pushups.png?v=20260809-exercise-medallions-v1",
  "exercise.pushups":"./assets/ui/quest-pushups.png?v=20260809-exercise-medallions-v1",
  "quest.dips":"./assets/ui/quest-dips.png?v=20260809-exercise-medallions-v1",
  "exercise.dips":"./assets/ui/quest-dips.png?v=20260809-exercise-medallions-v1",
  "quest.crunches":"./assets/ui/quest-abs.png?v=20260809-exercise-medallions-v1",
  "exercise.crunches":"./assets/ui/quest-abs.png?v=20260809-exercise-medallions-v1",
  "quest.plank":"./assets/ui/quest-abs.png?v=20260809-exercise-medallions-v1",
  "exercise.plank":"./assets/ui/quest-abs.png?v=20260809-exercise-medallions-v1",
  "quest.side_plank":"./assets/ui/quest-abs.png?v=20260809-exercise-medallions-v1",
  "exercise.side_plank":"./assets/ui/quest-abs.png?v=20260809-exercise-medallions-v1",
  "quest.negative_pullups":"./assets/ui/quest-pullups.png?v=20260809-exercise-medallions-v1",
  "exercise.negative_pullups":"./assets/ui/quest-pullups.png?v=20260809-exercise-medallions-v1",
  "quest.australian_pullups":"./assets/ui/quest-pullups.png?v=20260809-exercise-medallions-v1",
  "exercise.australian_pullups":"./assets/ui/quest-pullups.png?v=20260809-exercise-medallions-v1",
