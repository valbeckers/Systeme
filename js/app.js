  ...
  function Home(){
    ...
    return h("div",{class:"tab"},
      ...
      h("div",{class:"card"},
        ...
        h("div",{style:"display:grid;grid-template-columns:minmax(0,1fr) 1px minmax(0,1fr);align-items:center;justify-items:stretch;margin-top:12px;padding-top:10px;padding-bottom:0px;border-top:1px solid rgba(255,255,255,0.06)"},
