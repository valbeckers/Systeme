...
const SP = {
  ...
  Esprit:[
    {id:"sp_learning", name:"Apprentissage actif",  icon:"\uD83C\uDF93",                                  unit:"jour", target:1, xp:1000, days:1, binary:true, desc:"1h d'apprentissage actif"},
