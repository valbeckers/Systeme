...
function buildState(){
  ...
  const out={
    ...
    inventory:saved.inventory||{majorElixir:0,minorElixir:0,supremeElixir:0,transmutationGrimoire:0,masterContract:0,overachievementMark:0,recordHammer:0,teleportCrystal:0,invisibilityCape:0,debtAcknowledgement:0},
...
function App(){
  ...
  const debtStreakRollGuard = useRef(new Set());
  useEffect(()=>{
    const n=Number(state.streak)||0;
    if(!allDailyDone || n<=0 || n%5!==0) return;
    if((state.debtStreakRollMilestones||[]).includes(n) || debtStreakRollGuard.current.has(n)) return;
    debtStreakRollGuard.current.add(n);
    setState(s=>({...s,debtStreakRollMilestones:[...(s.debtStreakRollMilestones||[]),n]}));
    if(Math.random()<0.25) awardInventoryItem("debtAcknowledgement","rare");
  },[allDailyDone,state.streak]);
...
const BONUS_BADGE_COLOR = "#fbbf24";
  ...
  const NEW_ITEM_ICON_DATA={
    ...
    recordHammer:"data:image/png;base64,",
  ...
  const DEBT_ACKNOWLEDGEMENT_ICON_DATA="data:image/png;base64,";
  ...
  function Inventory(){
    const ids=["dungeonKey","debtAcknowledgement","majorElixir","minorElixir","supremeElixir","transmutationGrimoire","masterContract","overachievementMark","recordHammer","teleportCrystal","invisibilityCape"]
      .sort((a,b)=>{
    ...
    return h("div",{class:"tab"},
      h("div",{style:"display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px"},ids.map(id=>{
        const it=INVENTORY_ITEMS[id], qty=itemQty(id), grey=qty<1||(["majorElixir","minorElixir","supremeElixir"].includes(id)&&!!activeElixir);
  ...
  function ItemUseUp(){
    ...
    return h("div",{class:"ruov",style:"--rc:"+rank.color+";--rg:"+rank.glow},h("div",{class:"rucont"},
      h(NotificationHeader,null),
      h("div",{class:"ruevol",style:"color:"+rank.color},itemUseUp.id==="dungeonKey"?"Vous avez utilisé une":itemUseUp.id==="debtAcknowledgement"?"Dette créée avec une":itemUseUp.id==="transmutationGrimoire"?"Transmutation accomplie":"Vous avez consommé un"),
